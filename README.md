...
- [Scope](#scope)
- [Papers](#papers)
  - [Joint Hand-Object Reconstruction](#joint-hand-object-reconstruction)
    - [Single-Image](#single-image)
    - [Monocular Video](#monocular-video)
  - [Object Reconstruction in HOI Context](#object-reconstruction-in-hoi-context)
  - [Others](#others)
...
Papers are grouped first by task type, then by input type within each task. Entries are in reverse chronological order within each group.

### Joint Hand-Object Reconstruction

Methods that jointly reconstruct both hands and interacting objects — hand pose/mesh and object shape/pose together.
...
### Object Reconstruction in HOI Context

Methods that reconstruct only the **object** geometry or pose, leveraging hand interaction cues — such as contact, occlusion patterns, or interaction timelines — rather than performing joint hand-object estimation.
...
Adjacent works kept for reference. These are not joint hand-object reconstruction methods; each is grouped under its category below.

#### Hand Reconstruction

Methods that reconstruct only the hand, without estimating interacting object geometry.
